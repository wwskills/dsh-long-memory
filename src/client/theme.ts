...
export const style = {
  ...
  sidebar: { overflowY: 'auto', borderRight: `1px solid ${C.border}`, flexShrink: 0, background: C.layer1, display: 'flex', flexDirection: 'column' } as CSSProperties,
  ...
  header: { padding: `${space.lg}px ${space.xl}px 0`, borderBottom: `1px solid ${C.border}` } as CSSProperties,
  ...
  // Form controls
  input: { height: 36, padding: `0 ${space.md}px`, background: C.input, color: C.text, border: `1px solid ${C.border}`, borderRadius: radius.md, fontSize: font.md, width: '100%', boxSizing: 'border-box', outline: 'none' } as CSSProperties,
  ...
  btnOutline: { height: 32, padding: `0 ${space.lg}px`, background: 'transparent', color: C.secondary, border: `1px solid ${C.border}`, borderRadius: radius.md, fontSize: font.md, cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: space.xs } as CSSProperties,
  btnDanger: { height: 32, padding: `0 ${space.lg}px`, background: 'transparent', color: C.danger, border: `1px solid ${C.danger}`, borderRadius: radius.md, fontSize: font.md, cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: space.xs } as CSSProperties,
  btnPill: { height: 26, padding: `0 ${space.md}px`, border: `1px solid ${C.border}`, background: 'transparent', color: C.secondary, borderRadius: radius.pill, fontSize: font.sm, cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: space.xs } as CSSProperties,
  ...
  modalCard: { background: C.layer2, borderRadius: radius.lg, padding: space.xl, width: 520, maxWidth: '92vw', maxHeight: '85vh', overflowY: 'auto', border: `1px solid ${C.border}`, boxShadow: '0 20px 40px rgba(0,0,0,0.35)' } as CSSProperties,
