...
export declare const C: {
    ...
    readonly skeleton: "var(--dsw-alias-bg-layer-2, #f1f2f5)";
...
export declare const accentSoft = "color-mix(in srgb, var(--dsw-alias-brand-primary, #3b6ef6) 12%, transparent)";
