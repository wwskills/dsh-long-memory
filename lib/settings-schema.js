...
export const settingsSchema = {
  ...
  fields: [
    ...
    { key: 'l7.extractorTemp',  type: 'number',  label: 'Extractor temp',    default: 0.2 },
    {
      ...
      default: 0.6,
      description: 'L7 candidates with confidence below this value go to the confirm queue instead of being inserted as active memories. Set to 0 to disable queuing (all extractions inserted directly). Set to 1.0 to require confirmation for all L7 extractions.'
    },
    ...
    // ── agent-evolve merge: self-evolving config ──
