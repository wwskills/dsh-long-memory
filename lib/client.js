window.__ModuleLoader__.load({ id: '@wwskills/dsh-long-memory', factory: (require) => { var module = { exports: {} };
"use strict";
...
var font = { xs: 11, sm: 12, md: 13, lg: 15, xl: 16 };
...
var style = {
  ...
  header: { padding: `${space.sm}px ${space.lg}px`, borderBottom: `1px solid ${C.border}` },
  tabPanel: { flex: 1, overflowY: "auto", padding: `${space.lg}px ${space.lg}px` },
  // Cards
  ...
  title: { fontSize: font.lg, fontWeight: 600, color: C.text, margin: 0 },
  sectionTitle: { fontSize: font.md, fontWeight: 600, color: C.secondary, margin: 0 },
  ...
  // Form controls
  input: { height: 32, padding: `0 ${space.md}px`, background: C.input, color: C.text, border: `1px solid ${C.border}`, borderRadius: radius.md, fontSize: font.md, width: "100%", boxSizing: "border-box", outline: "none" },
  ...
  btnPrimary: { height: 32, padding: `0 14px`, background: C.primaryFill, color: C.textFg, border: "none", borderRadius: 18, fontSize: 14, fontWeight: 500, cursor: "pointer", display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 4 },
  btnOutline: { height: 32, padding: `0 14px`, background: "transparent", color: C.text, border: `0.5px solid ${C.borderL3}`, borderRadius: 18, fontSize: 14, cursor: "pointer", display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 4 },
  btnDanger: { height: 32, padding: `0 14px`, background: "transparent", color: C.danger, border: `0.5px solid ${C.danger}`, borderRadius: 18, fontSize: 14, cursor: "pointer", display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 4 },
  btnPill: { height: 24, padding: `0 8px`, border: "none", background: C.layer2, color: C.secondary, borderRadius: 12, fontSize: font.sm, cursor: "pointer", display: "inline-flex", alignItems: "center", gap: 4 },
  ...
  // States
  empty: { textAlign: "center", padding: `${space.xxl * 2}px ${space.lg}px`, color: C.tertiary, fontSize: font.md },
  errorBox: { textAlign: "center", padding: `40px ${space.lg}px`, color: C.danger, fontSize: font.md },
  // Badges — DSH _pill style: neutral bg, 12px radius
  countBadge: { display: "inline-flex", alignItems: "center", justifyContent: "center", minWidth: 18, height: 18, padding: `0 5px`, borderRadius: 9, background: C.accent, color: C.textFg, fontSize: font.xs, fontWeight: 500, lineHeight: "18px" },
  // Toast
  ...
  modalCard: { background: C.layer2, borderRadius: radius.lg, padding: space.lg, width: 520, maxWidth: "92vw", maxHeight: "85vh", overflowY: "auto", border: `1px solid ${C.border}`, boxShadow: "0 20px 40px rgba(0,0,0,0.35)" },
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("svg", { "aria-hidden": true, width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", "stroke-width": "1.2", style: { flexShrink: 0 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: "M8 1.5a3 3 0 0 0-3 3v.5a3 3 0 0 0-2 2.8v.4a3 3 0 0 0 2 2.8v.5a3 3 0 0 0 6 0v-.5a3 3 0 0 0 2-2.8v-.4a3 3 0 0 0-2-2.8v-.5a3 3 0 0 0-3-3z" }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: "M6 8h4M6 5h4M6 11h4" })
          ] }),
