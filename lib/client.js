...
var accentSoft = "color-mix(in srgb, var(--dsw-alias-brand-primary, #3b6ef6) 12%, transparent)";
...
var style = {
  ...
  sidebar: { overflowY: "auto", borderRight: `0.5px solid ${C.border}`, flexShrink: 0, background: C.layer1, display: "flex", flexDirection: "column" },
  sash: { width: 4, cursor: "col-resize", flexShrink: 0, background: C.border, position: "relative" },
  main: { flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", minWidth: 0 },
  header: { padding: `${space.lg}px ${space.xl}px 0`, borderBottom: `0.5px solid ${C.border}` },
  tabPanel: { flex: 1, overflowY: "auto", padding: `${space.lg}px ${space.xl}px` },
  // Cards
  card: { background: C.layer2, border: `0.5px solid ${C.border}`, borderRadius: 24 },
  ...
  // Form controls
  input: { height: 36, padding: `0 ${space.md}px`, background: C.input, color: C.text, border: `0.5px solid ${C.border}`, borderRadius: radius.md, fontSize: 14, width: "100%", boxSizing: "border-box", outline: "none" },
  textarea: { minHeight: 96, padding: `10px ${space.md}px`, background: C.input, color: C.text, border: `0.5px solid ${C.border}`, borderRadius: radius.md, fontSize: 14, resize: "vertical", width: "100%", boxSizing: "border-box", outline: "none", fontFamily: "inherit", lineHeight: 1.5 },
  // Buttons
  ...
  btnOutline: { height: 32, padding: `0 ${space.lg}px`, background: "transparent", color: C.secondary, border: `0.5px solid ${C.border}`, borderRadius: radius.md, fontSize: font.md, cursor: "pointer", display: "inline-flex", alignItems: "center", gap: space.xs },
  btnDanger: { height: 32, padding: `0 ${space.lg}px`, background: "transparent", color: C.danger, border: `0.5px solid ${C.danger}`, borderRadius: radius.md, fontSize: font.md, cursor: "pointer", display: "inline-flex", alignItems: "center", gap: space.xs },
  btnPill: { height: 26, padding: `0 ${space.md}px`, border: `0.5px solid ${C.border}`, background: "transparent", color: C.secondary, borderRadius: radius.pill, fontSize: font.sm, cursor: "pointer", display: "inline-flex", alignItems: "center", gap: space.xs },
  ...
  modalCard: { background: C.layer2, borderRadius: 24, padding: space.xl, width: 520, maxWidth: "92vw", maxHeight: "85vh", overflowY: "auto", border: `0.5px solid ${C.border}`, boxShadow: "0 20px 40px rgba(0,0,0,0.35)" },
  ...
  // Popover menu
  popoverMenu: { position: "absolute", top: "100%", right: 0, marginTop: space.xs, background: C.layer2, border: `0.5px solid ${C.border}`, borderRadius: 18, boxShadow: "0 8px 24px rgba(0,0,0,0.18)", zIndex: 1e3, minWidth: 150, padding: space.xs },
...
function RecallTab(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("h3", { style: { ...style.sectionTitle, marginBottom: space.md }, children: t("recallTab") }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { style: { fontSize: font.md, color: C.secondary, marginTop: 0, marginBottom: space.lg }, children: t("recallHint") }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { display: "flex", gap: space.sm, marginBottom: space.lg }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { className: "lm-primary", style: { ...style.btnPrimary, height: 36, flexShrink: 0 }, disabled: loading || query.trim() === "", onClick: run, children: loading ? t("recallSearching") : t("recallSearch") })
    ] }),
    loading ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(SkeletonList, { count: 3 }) : error !== null ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(ErrorState, { t, message: error }) : results !== null && results.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(EmptyState, { children: t("recallNoResults") }) : (results ?? []).map((m, i) => {
      const typeMeta = memoryTypeMeta(m.type);
      return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "lm-card", style: { ...style.card, ...style.cardPad, marginBottom: space.sm }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: space.sm, marginBottom: space.sm }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { style: { fontSize: font.xs, color: C.tertiary, fontVariantNumeric: "tabular-nums" }, children: [
            "#",
            i + 1
          ] }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { style: { fontSize: font.md, color: C.text, margin: 0, lineHeight: 1.6, wordBreak: "break-word" }, children: (m.content ?? "").slice(0, 300) })
      ] }, m.id);
    })
  ] });
}
...
function SettingsPanel(props) {
  const { t } = props;
  useInjectCss();
  const [enabled, setEnabled2] = (0, import_react6.useState)(true);
  const [activeTab, setActiveTab] = (0, import_react6.useState)("lessons");
  const [badges, setBadges] = (0, import_react6.useState)({ lessons: 0, rules: 0 });
  const [stats, setStats] = (0, import_react6.useState)(null);
  const [highlightId, setHighlightId] = (0, import_react6.useState)(null);
  const [settingsOpen, setSettingsOpen] = (0, import_react6.useState)(false);
  const [embeddingStatus, setEmbeddingStatus] = (0, import_react6.useState)(null);
  ...
  const renderTab = () => {
    switch (activeTab) {
      case "lessons":
        return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(CorrectionsTab, { t, setBadges, highlightId, onClearHighlight: () => setHighlightId(null), showToast });
      case "rules":
        return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(RulesTab, { t, setBadges, showToast, onJumpToCorrection: (id) => {
          setActiveTab("lessons");
          setHighlightId(id);
        } });
      case "recall":
        return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(RecallTab, { t, showToast });
      default:
        return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_jsx_runtime6.Fragment, {});
    }
  };
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "lm-panel lm-scroll", style: { ...style.root, width: "100%", height: "100%" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: style.main, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: style.header, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", paddingBottom: space.sm }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h2", { style: style.title, children: t("title") }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: space.sm }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { className: "lm-btn", style: { ...style.btnOutline, height: 28, fontSize: font.sm, padding: "0 10px", borderRadius: 14 }, onClick: () => setSettingsOpen(true), children: t("configBtn") }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { style: { display: "flex", alignItems: "center", gap: space.xs }, title: t("switchHint"), children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Switch, { checked: enabled, onChange: toggleEnabled, ariaLabel: enabled ? t("switchOn") : t("switchOff") }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { fontSize: font.sm, color: enabled ? C.success : C.tertiary, fontWeight: 500 }, children: enabled ? t("switchOn") : t("switchOff") })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { role: "tablist", style: { display: "flex", gap: "2px" }, children: TABS.map((tab) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: t(tab.labelKey) }),
                badgeCount > 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: {
                  display: "inline-flex",
                  alignItems: "center",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { role: "tabpanel", style: style.tabPanel, className: "lm-scroll", children: renderTab() })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Toast, { toasts, onDismiss: dismissToast }),
    settingsOpen ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      SettingsModal,
      {
        t,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_dsh_client_ui_primitives.IconDataOutline16, { size: props.wide ? 16 : 18 }),
          props.wide ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { children: t("tab") }) : null
        ]
      }
    ),
    open ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { position: "relative", width: "90vw", maxWidth: 1100, height: "85vh", background: C.bg, borderRadius: radius.lg, overflow: "hidden", border: `1px solid ${C.border}`, boxShadow: "0 24px 60px rgba(0,0,0,0.4)" }, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(SettingsPanel, { t })
        ] })
      }
    ) : null
  ] });
...
function apply(ctx) {
  ...
  ctx.slots.inject(
    ...
    () => ctx.slots.register(
      ...
      (slotProps) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(SidebarEntry, { t, wide: slotProps.wide === true })
    )
  );
}
